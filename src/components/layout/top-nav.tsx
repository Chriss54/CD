...
export function TopNav({ showAdminLink }: TopNavProps) {
    ...
    <nav className="border-b border-border bg-white relative">
      <div className="max-w-7xl mx-auto px-4 h-12 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {/* Notification bell */}
          <button className="flex items-center gap-2 px-3 py-2 rounded-full text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
